...
export const TURN_HOLD_DELAY = 0.18;
export const RAINBOW_DURATION = 5;
export const COMBO_RAINBOW_DURATION = 7;
export const COMBO_REFERENCE_WIDTH = 700;
export const COMBO_MINIMUM_VIEWPORT_SCALE = 0.8;
export const MINIMUM_COMBO_DURATION = 2;
export const COMBO_EFFECT_DURATION = 0.9;
export const LOOP_GLOW_DURATION = 0.65;
export const PARTICLES_PER_CLOUD = 9;
export const PARTICLES_PER_STAR = 20;
export const MAX_CAPTURE_PARTICLES = 80;
export const PARTICLE_MIN_SPEED = 35;
export const PARTICLE_MAX_SPEED = 105;
export const PARTICLE_LIFETIME = 0.8;
export const PARTICLE_GRAVITY = 45;
export const BGM_TEMPO = 112;
...
export const CLOUD_MIN_SPACING = 160;
export const CLOUD_MAX_SPACING = 300;

export const INK_DROP_MIN_INTERVAL = 1.4;
export const INK_DROP_MAX_INTERVAL = 2.6;
export const INK_DROP_MIN_SPEED = 35;
export const INK_DROP_MAX_SPEED = 160;
export const INK_DROP_MIN_RADIUS = 8;
export const INK_DROP_MAX_RADIUS = 12;
export const PLAYER_COLLISION_RADIUS = 12;

export const BONUS_STAR_MIN_SPACING = 1400;
export const BONUS_STAR_MAX_SPACING = 2200;
export const BONUS_STAR_RADIUS = 15;
export const BONUS_STAR_SCORE = 3000;
export const STAR_TIME_DURATION = 10;
export const STAR_TIME_SPEED_MULTIPLIER = 0.65;
